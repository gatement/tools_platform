...
(function($, tp){
	...
	function Note()
	{
		...
		this.arrangeNotes.noteHorizontalPadding = 20; // note horizontal margin+border+padding
		this.arrangeNotes.noteVerticalPadding = 33; // note vertical margin+border+padding
	...
	$.extend(Note.prototype, {
		...
		get_sorted_notes: function(desc)
		{
			// get note array
			var notes=[];
			$notes = $(".note");
		...
		maximize_note:function($note)
		{
			...
			var width = me.get_client_width() - left - this.arrangeNotes.noteHorizontalPadding - me.arrangeNotes.horizontalGap;
			var height = me.get_client_height() - me.arrangeNotes.defaultTop - this.arrangeNotes.noteVerticalPadding - me.arrangeNotes.verticalGap;
